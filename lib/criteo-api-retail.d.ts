...
interface CreateCampaign {
    data: {
        ...
        attributes: RequireOnly<CampaignAttributes, "name">
    }
}
...
interface UpdateCampaign {
    data: {
        id: string,
        type: "RetailMediaCampaign",
        attributes: RequireOnly<CampaignAttributes, "name" | "budget" | "clickAttributionWindow" | "viewAttributionWindow">
    }
}
...
interface CreateLineItem {
    ...
    attributes: RequireOnly<LineItemAttributes, "name" | "targetRetailerId" | "startDate">
}

interface UpdateLineItem {
    id: string,
    type: "RetailMediaLineItem",
    attributes: RequireOnly<LineItemAttributes, "name" | "startDate" | "endDate" | "budget" | "monthlyPacing" | "dailyPacing" | "isAutoDailyPacing" | "bidStrategy" | "targetBid" | "maxBid" | "status">
}
...
declare class Criteo_API {
    ...
    createLineItemByCampaignId(accountId: string, lineItemData: CreateLineItem, callback?: (err: any, res: any) => void): Promise<LineItemResponse | undefined>;
